...
namespace PatchKit.Api
{
    ...
    {
        public Job GetJobInfo(string guid, Timeout? timeout)
        {
            if (guid == null)
            {
        ...
        public LicenseKeysCollection GetCollectionKeys(int collectionId, string token, int size, int offset, Timeout? timeout)
        {
            if (token == null)
            {
        ...
        public LicenseKey GetKeyInfo(string key, string appSecret, string keySecret, Timeout? timeout)
        {
            if (key == null)
            {
